...
import (
	...
	notarysignerresources "github.com/ovh/harbor-operator/controllers/notarysigner/resources"
...
func (r *Reconciler) UpdateAppliedStatus(ctx context.Context, result *ctrl.Result, notary *containerregistryv1alpha2.NotarySigner) error {
...
func (r *Reconciler) UpdateReadyStatus(ctx context.Context, result *ctrl.Result, notary *containerregistryv1alpha2.NotarySigner) error {
