...
import (
	...
	"github.com/ovh/harbor-operator/controllers/core"
	"github.com/ovh/harbor-operator/controllers/notaryserver"
	"github.com/ovh/harbor-operator/controllers/portal"
	"github.com/ovh/harbor-operator/controllers/registry"
)

func (r *Reconciler) GetCoreIngresse(ctx context.Context, harbor *containerregistryv1alpha2.Harbor) (*netv1.Ingress, error) {
	...
	rules := []netv1.HTTPIngressPath{
		{
			...
			Backend: netv1.IngressBackend{
				ServiceName: harbor.NormalizeComponentName(containerregistryv1alpha2.CoreName),
	...
	if harbor.Spec.Components.Portal != nil {
		rules = append(rules, netv1.HTTPIngressPath{
			Path: "/",
			Backend: netv1.IngressBackend{
				ServiceName: harbor.NormalizeComponentName(containerregistryv1alpha2.PortalName),
	...
	if harbor.Spec.Components.Registry != nil {
		rules = append(rules, netv1.HTTPIngressPath{
			Path: "/v2",
			Backend: netv1.IngressBackend{
				ServiceName: harbor.NormalizeComponentName(containerregistryv1alpha2.RegistryName),
...
func (r *Reconciler) GetNotaryServerIngresse(ctx context.Context, harbor *containerregistryv1alpha2.Harbor) (*netv1.Ingress, error) {
							...
							Paths: []netv1.HTTPIngressPath{
								{
									Path: "/",
									Backend: netv1.IngressBackend{
										ServiceName: harbor.NormalizeComponentName(containerregistryv1alpha2.NotaryServerName),
