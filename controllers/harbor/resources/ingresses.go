...
import (
	...
	portalresources "github.com/ovh/harbor-operator/controllers/portal/resources"
...
func (m *Manager) GetCoreIngresses(ctx context.Context) ([]*netv1.Ingress, error) {
	...
	rules := []netv1.HTTPIngressPath{
		{
			...
			Backend: netv1.IngressBackend{
				ServiceName: m.Harbor.NormalizeComponentName(containerregistryv1alpha2.CoreName),
	...
	if m.Harbor.Spec.Components.Portal != nil {
		rules = append(rules, netv1.HTTPIngressPath{
			Path: "/",
			Backend: netv1.IngressBackend{
				ServiceName: m.Harbor.NormalizeComponentName(containerregistryv1alpha2.PortalName),
	...
	if m.Harbor.Spec.Components.Registry != nil {
		rules = append(rules, netv1.HTTPIngressPath{
			Path: "/v2",
			Backend: netv1.IngressBackend{
				ServiceName: m.Harbor.NormalizeComponentName(containerregistryv1alpha2.RegistryName),
	...
	return []*netv1.Ingress{
		{
			ObjectMeta: metav1.ObjectMeta{
				...
				Labels: map[string]string{
					"app":      containerregistryv1alpha2.HarborName,
								...
								Paths: []netv1.HTTPIngressPath{
									{
										Path: "/",
										Backend: netv1.IngressBackend{
											ServiceName: m.Harbor.NormalizeComponentName(containerregistryv1alpha2.NotaryServerName),
