	...
	return []*certv1.Certificate{
		{
			...
			Spec: certv1.CertificateSpec{
				...
				SecretName:   fmt.Sprintf("%s-%s", m.Harbor.NormalizeComponentName(containerregistryv1alpha2.NotarySignerName), "certificate"),
				KeySize:      m.Harbor.Spec.Components.NotarySigner.KeySize,
				KeyAlgorithm: certv1.RSAKeyAlgorithm,
				KeyEncoding:  certv1.PKCS1,
				DNSNames: []string{
					m.Harbor.NormalizeComponentName(containerregistryv1alpha2.NotaryName),
