...
import (
	...
	"github.com/ovh/harbor-operator/pkg/controllers/health"
...
func (r *Reconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	r.Controller.Client = r.Client
	r.Controller.Status = r.Client

	return ctrl.NewControllerManagedBy(mgr).
		WithEventFilter(&class.Filter{
			ClassName: r.Config.ClassName,
		}).
		For(&containerregistryv1alpha2.ChartMuseum{}).
...
// +kubebuilder:rbac:groups=containerregistry.ovhcloud.com,resources=chartmuseums,verbs=get;list;watch;create;update;patch;delete
