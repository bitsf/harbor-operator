	...
	Describe("Creating Harbor resources", func() {
		Context("with invalid version", func() {
			It("should raise an error", func() {
				harbor := &containerregistryv1alpha2.Harbor{
					...
					Spec: containerregistryv1alpha2.HarborSpec{
		...
		Context("with valid spec", func() {
			It("should be handled", func() {
				...
				getConditions := func(harbor *containerregistryv1alpha2.Harbor) []containerregistryv1alpha2.ComponentCondition {
				...
				Eventually(getResourceFunc(ctx, key, harbor, getConditions), applyTimeoutInterval).Should(ContainElement(gstruct.MatchFields(gstruct.IgnoreExtras, gstruct.Fields{
					"Type":   BeEquivalentTo(containerregistryv1alpha2.AppliedConditionType),
	...
	Describe("Handling resource events", func() {
		Context("Updating Harbor resource spec", func() {
			It("should update ObservedGeneration", func() {
				...
				getObservedGeneration := func(harbor *containerregistryv1alpha2.Harbor) int64 {
...
func getUpdateFunc(ctx context.Context, harbor *containerregistryv1alpha2.Harbor) func() error {
	return func() error {
...
func newValidHarborTest(ns string) (*containerregistryv1alpha2.Harbor, client.ObjectKey) {
	name := newName("harbor")
	publicURL := url.URL{
		Scheme: "http",
		Host:   "the.dns",
	...
	harbor := &containerregistryv1alpha2.Harbor{
		...
		Spec: containerregistryv1alpha2.HarborSpec{
			...
			Components: containerregistryv1alpha2.HarborComponents{
				Core: &containerregistryv1alpha2.CoreComponent{
					CoreConfig: containerregistryv1alpha2.CoreConfig{
						DatabaseSecret: "core-database-secret",
					},
				},
				JobService: &containerregistryv1alpha2.JobServiceComponent{
					JobServiceConfig: containerregistryv1alpha2.JobServiceConfig{
						RedisSecret: "jobservice-redis-secret",
					},
				},
				Portal:   &containerregistryv1alpha2.PortalComponent{},
				Registry: &containerregistryv1alpha2.RegistryComponent{},
			},
		},
	}
	harbor.Default()
