...
// +kubebuilder:webhook:path=/mutate-containerregistry-ovhcloud-com-v1alpha2-harbor,mutating=true,failurePolicy=fail,groups=containerregistry.ovhcloud.com,resources=harbors,verbs=create;update,versions=v1alpha2,name=mharbor.kb.io
