	...
	Context("With no harbor-class", func() {
		...
		Describe("Creation event", func() {
			Context("For an Harbor resource", func() {
				...
				BeforeEach(func() {
					h = &containerregistryv1alpha2.Harbor{}
				})
				...
				Context("With other annotations", func() {
					BeforeEach(func() {
						h.SetAnnotations(map[string]string{
							fmt.Sprintf("%s-false", containerregistryv1alpha2.HarborClassAnnotation): "",
						})
					})
				...
				Context("With empty class", func() {
					BeforeEach(func() {
						h.SetAnnotations(map[string]string{
							containerregistryv1alpha2.HarborClassAnnotation: "",
						})
					})
				...
				Context("With other-class should not match", func() {
					BeforeEach(func() {
						h.SetAnnotations(map[string]string{
							containerregistryv1alpha2.HarborClassAnnotation: "other-class",
						})
					})
		...
		Describe("Deletion event", func() {
			Context("For an Harbor resource", func() {
				var h *containerregistryv1alpha2.Harbor
				...
				Context("With the right class should match", func() {
					BeforeEach(func() {
						h.SetAnnotations(map[string]string{
							containerregistryv1alpha2.HarborClassAnnotation: cf.ClassName,
						})
					})
		...
		Describe("Update event", func() {
			Context("From an Harbor resource", func() {
				var oldResource *containerregistryv1alpha2.Harbor

				BeforeEach(func() {
					oldResource = &containerregistryv1alpha2.Harbor{}
				})
				...
				Context("With no annotation", func() {
					...
					Context("To resource", func() {
						var newResource *containerregistryv1alpha2.Harbor

						BeforeEach(func() {
							newResource = &containerregistryv1alpha2.Harbor{}
						})
				...
				Context("With other annotations", func() {
					...
					Context("To resource", func() {
						...
						Context("With no annotation", func() {
							...
							It("Should match", func() {
								ok := cf.Update(event.UpdateEvent{MetaOld: oldResource.GetObjectMeta(), ObjectOld: oldResource, MetaNew: newResource.GetObjectMeta(), ObjectNew: &containerregistryv1alpha2.Harbor{}})
								Expect(ok).To(BeTrue())
							})
						})
