...
func (r *Controller) GetConditionStatus(ctx context.Context, componentStatus *containerregistryv1alpha2.ComponentStatus, conditionType status.ConditionType) corev1.ConditionStatus {
	return r.GetCondition(ctx, componentStatus, conditionType).Status
}

func (r *Controller) UpdateCondition(ctx context.Context, componentStatus *containerregistryv1alpha2.ComponentStatus, conditionType status.ConditionType, conditionStatus corev1.ConditionStatus, reasons ...string) error {
