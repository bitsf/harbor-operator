...
func (r *Controller) ApplyMutationFunc(ctx context.Context, harbor *containerregistryv1alpha1.Harbor, resource components.Resource, result metav1.Object, mutate controllerutil.MutateFn) func() error {
	return func() error {
		// Immutable field
...
func (r *Controller) ApplyResource(ctx context.Context, harbor *containerregistryv1alpha1.Harbor, resource components.Resource, objectFactory components.ResourceFactory, objectMutation components.ResourceMutationGetter) (components.Resource, error) {
...
func (r *Controller) ApplyResources(ctx context.Context, harbor *containerregistryv1alpha1.Harbor, resources []components.Resource, objectFactory func() components.Resource, objectMutation func(components.Resource, components.Resource) controllerutil.MutateFn) error {
...
func (r *Controller) ApplyComponent(ctx context.Context, harbor *containerregistryv1alpha1.Harbor, component *components.ComponentRunner) error {
...
func (r *Controller) Apply(ctx context.Context, harbor *containerregistryv1alpha1.Harbor) error {
