...
func (r *Controller) CreateResource(ctx context.Context, harbor *containerregistryv1alpha1.Harbor, resource components.Resource) error {
...
func (r *Controller) CreateResources(ctx context.Context, harbor *containerregistryv1alpha1.Harbor, resources []components.Resource) error {
...
func (r *Controller) CreateComponent(ctx context.Context, harbor *containerregistryv1alpha1.Harbor, component *components.ComponentRunner) error {
...
func (r *Controller) Create(ctx context.Context, harbor *containerregistryv1alpha1.Harbor) error {
